...
|-------|--------|-----|-------|-----------|------|-------|---------|
| `/` Dashboard | 8 | 8 | 8 | 4 | 8 | 8 | **7.3** → **8.0** |
| `/lab` | 8 | 8 | 8 | 4 | 7 | 8 | **7.2** → **8.0** |
| `/players` | 7 | 7 | 6 | 4 | 7 | 6 | **6.2** → **7.5** |
| `/results` Grading | 7 | 8 | 8 | — | 7 | 8 | **7.6** → **8.0** |
| `/results` Analytics | 7 | 8 | 7 | 8 | 7 | 6 | **7.2** → **8.0** |
| `/compare` | 7 | 8 | 7 | 7 | 7 | 7 | **7.2** → **8.0** |
| `/eval` | 6 | 7 | 6 | 6 | 7 | 5 | **6.2** (tier-2) |
| `/system` | 7 | 8 | 8 | 4 | 8 | 6 | **6.8** → **8.0** |

**Core five + system:** Target met in code; operator perceptual test (Sunday workflow) is the final gate.
