                    ...
                    "properties": {
                        ...
                        "strategy_overrides": {
                            ...
                            "properties": {
                                ...
                                "matchup_ev_threshold": {"type": ["number", "null"]},
                                "platt_a": {"type": ["number", "null"]},
                                "platt_b": {"type": ["number", "null"]},
                                "dg_matchup_blend_weight": {"type": ["number", "null"]},
                                "model_matchup_blend_weight": {"type": ["number", "null"]},
                                "min_composite_gap": {"type": ["number", "null"]},
                                "max_win_prob_cap": {"type": ["number", "null"]},
