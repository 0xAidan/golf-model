                ...
                "items": {
                    ...
                    "properties": {
                        ...
                        "strategy_overrides": {
                            "type": "object",
                            "properties": {
                                "w_sg_total": {"type": "number"},
                                "w_sg_app": {"type": "number"},
                                "w_sg_ott": {"type": "number"},
                                "w_sg_arg": {"type": "number"},
                                "w_sg_putt": {"type": "number"},
                                "w_form": {"type": "number"},
                                "w_course_fit": {"type": "number"},
                                "w_sub_course_fit": {"type": "number"},
                                "w_sub_form": {"type": "number"},
                                "w_sub_momentum": {"type": "number"},
                                "stat_window": {"type": "integer"},
                                "min_ev": {"type": "number"},
                                "max_implied_prob": {"type": "number"},
                                "min_model_prob": {"type": "number"},
                                "kelly_fraction": {"type": "number"},
                                "softmax_temp": {"type": "number"},
                                "ai_adj_cap": {"type": "number"},
                                "use_weather": {"type": "boolean"},
                            },
